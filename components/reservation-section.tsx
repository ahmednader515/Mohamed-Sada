  ...
  return (
    <section className="py-20 bg-gradient-to-br from-[#27c08d]/5 to-[#1e3a8a]/5">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="w-16 h-16 bg-[#8B0620]/10 rounded-full flex items-center justify-center mx-auto mb-6">
            <Calendar className="h-8 w-8 text-[#8B0620]" />
          </div>
            ...
            <Card className="shadow-lg">
              <CardHeader>
                <CardTitle className="text-center flex items-center justify-center gap-2">
                  <Calendar className="h-5 w-5 text-[#8B0620]" />
                  طلب حجز استشارة
                </CardTitle>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    ...
                    disabled={isLoading}
                  >
                    {isLoading ? "جاري الإرسال..." : "إرسال طلب الاستشارة"}
                  </Button>
                </form>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-6">
                <div className="text-center">
                  <p className="text-green-800 dark:text-green-200 mb-4">
                    شكراً لك! تم إرسال طلب الاستشارة بنجاح. سنتواصل معك قريباً لتأكيد الموعد.
                  </p>
                  <p className="text-sm text-green-700 dark:text-green-300">
                    يمكنك إرسال طلب استشارة آخر إذا كنت تريد ذلك.
                  </p>
                </div>
